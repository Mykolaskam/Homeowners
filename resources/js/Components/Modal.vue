                        ...
                        <DialogPanel
                            ...
                            <div>
                                <div class="mx-auto flex items-center justify-center">
                                    <svg role="status" class="w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-indigo-600"
                                ...
                                <div class="mt-3 text-center sm:mt-5">
                                    <DialogTitle as="h3" class="text-lg leading-6 font-medium text-gray-900"> Processing File...</DialogTitle>
                                    <div class="mt-2">
                                        <p class="text-sm text-gray-500">It'll be ready any minute now.</p>
                                    </div>
                                </div>
                            </div>
                        </DialogPanel>
